...
from flaskr.utils import cf_turnstile_required

bp = Blueprint("auth", __name__, url_prefix="/auth")


@bp.route("/register", methods=("GET", "POST"))
@cf_turnstile_required(None, "register-form")
def register():
...
@cf_turnstile_required("login", "login-form")
def login():
    if request.method == "POST":
        username = request.form.get("username")
        password = request.form.get("password")
...
@login_required
@cf_turnstile_required(None, "changepassword-form")
def change_password():
    if request.method == "POST":
